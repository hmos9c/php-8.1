...
var_dump(sayHello(new Customer("1", "Sanas", Gender::from("Mr"))));
var_dump(sayHello(new Customer("2", "Balqis", Gender::from("Mrs"))));
var_dump(sayHello(new Customer("2", "Balqis", Gender::tryFrom("Salah"))));
